...
/** Mirrors app/login/page.tsx's mobile/desktop split — see that file's own
 *  comment for why the two layouts differ. Real chrome (logo, backgrounds —
 *  decorative, not data) plus skeleton blocks for the heading/fields. */
      ...
      <div className="hidden sm:block">
        <AuthPageShell>
          <div className="flex flex-col items-center">
            <Skeleton inverse className="h-6 w-40" />
            <Skeleton inverse className="mt-2 h-3 w-56 max-w-full" />
          </div>

          <div className="mt-6 space-y-4">
            <div>
              <Skeleton inverse className="h-3 w-16" />
              <Skeleton className="mt-1.5 h-11 w-full rounded-lg" />
            </div>
            <div>
              <Skeleton inverse className="h-3 w-20" />
              <Skeleton className="mt-1.5 h-11 w-full rounded-lg" />
            </div>
            <Skeleton className="h-13 w-full rounded-xl" />
          </div>
          ...
          <div className="mt-4 flex justify-center">
            <Skeleton inverse className="h-3 w-28" />
          </div>
          <div className="mt-3 flex justify-center">
            <Skeleton inverse className="h-3 w-44 max-w-full" />
          </div>
        </AuthPageShell>
      </div>
    </>
