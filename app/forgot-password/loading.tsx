...
/** Mirrors app/forgot-password/page.tsx's mobile/desktop split — see that
 *  file's own comment for why the two layouts differ. */
      ...
      <div className="hidden sm:block">
        <AuthPageShell>
          <div className="flex flex-col items-center">
            <Skeleton inverse className="h-6 w-56 max-w-full" />
          ...
          <div className="mt-5 flex justify-center">
            <Skeleton inverse className="h-3 w-32" />
          </div>
        </AuthPageShell>
      </div>
    </>
